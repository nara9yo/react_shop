...
const Footer = () => {
  ...
  return (
    <footer className="bg-slate-900 text-slate-100 py-10 mt-auto">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="text-slate-300">이메일: support@shop.com</li>
              <li className="text-slate-300">전화: 1588-0000</li>
              <li className="text-slate-300">운영시간: 평일 9:00-18:00</li>
            </ul>
          </div>
        </div>
